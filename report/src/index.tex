...
ityand a higher workload on employees due to the unreliabile of outdated software and hardwaree.

\section{Team Members \& Bios}\label{team-members-bios}

Include an entry in a narrative form for each of your team members (See
alpha prototype for starting material \& update as required). The goal
is to demonstrate the team's skills and project coverage. This is not
just a pasted in resume, but a summary of your involvement in the
project, and your technical interests. Include:
