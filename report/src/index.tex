...
\textbf{Security}\\
\begin{tabular}{|c|c|}\hline
Description & The app must contain a system to verity users in a secure \\
...
UPC entry & Frontend & Attempting to add an invalid UPC & Descriptive, unobsusive error with suggestions for fixing &  & \\ \hline
...
\item
  ...
  \begin{tabular}{|p{1.9cm}|p{1.9cm}|p{1.9cm}|p{1.9cm}|p{1.9cm}|p{1.9cm}|}\hline
  Component & Front/Back-end & Description & Expected Result & Observed Result & Pass/Fail\\ \hline
  Database & Backend & Requesting details for an item contained in the database & Item details are able to be retrieved accuratly & & \\ \hline.
  \end{tabular}
\item
...
\item
  ...
  \begin{tabular}{|p{1.9cm}|p{1.9cm}|p{1.9cm}|p{1.9cm}|p{1.9cm}|p{1.9cm}|}\hline
  Component & Front/Back-end & Description & Expected Result & Observed Result & Pass/Fail\\ \hline
  Checkout Screen Immutability & Frontend & Provided item list is unable to be changed in any way, at the checkout screen & Due to the nature of backend storage, any visual edits via (F12) inspect or by other means will be purely visual & &  \\ \hline
  \end{tabular}
\item
  Performance testing\\
  \begin{tabular}{|p{1.9cm}|p{1.9cm}|p{1.9cm}|p{1.9cm}|p{1.9cm}|p{1.9cm}|}\hline
  Component & Front/Back-end & Description & Expected Result & Observed Result & Pass/Fail\\ \hline
  All Pages & Frontend & UI is readable and practical at aspect ratios down to 4:3 and screen sizes down to 7'' & Aspect ratios and screen sizes will not be an issue, and the app will remain easy to use & & \\ \hline
  \end{tabular}
\item
  Standards and constraints testing\\
  \begin{tabular}{|p{1.9cm}|p{1.9cm}|p{1.9cm}|p{1.9cm}|p{1.9cm}|p{1.9cm}|}\hline
  Component & Front/Back-end & Description & Expected Result & Observed Result & Pass/Fail\\ \hline
  All Pages & Frontend & W3C Accessability compliance & Website is able to pass WAVE automated W3C testing &  &  \\ \hline 
  \end{tabular}
\item
